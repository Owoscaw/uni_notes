...
This is the integral over a rectangular area. A region $D$ is $y$-simple if every line that is parallel to the $y$-axis and intersects $D$ does so in a single line segment:![[y-simple example]]
