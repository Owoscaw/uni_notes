...
Giving us the result $dA=rdrd\theta$, used in [[Integration#Integration using polar coordinates|polar coordinate double integrals]]. Here is another example for using the Jacobian: ![[Integration .excalidraw]]