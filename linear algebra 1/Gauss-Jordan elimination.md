...
[[Matrix operations#Matrix multiplication|Matrix multiplication]] between $A$ and $x$ will give the entire original system of linear equations. $A$ is known as the coefficient matrix.
...
If $A\in M_n(\Re)$ and $\underline b\in\Re^n$