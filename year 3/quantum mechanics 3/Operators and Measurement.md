...
A common form for a unitary operator is given by the exponential of a Hermitian operator multiplied by $i$ and some real parameter $\theta$. Take for example the [[U(1),SU(2),SO(3)#Pauli matrices|Pauli matrices]] $\tau_2,\tau_3$:$$\Huge \tau_2=\begin{pmatrix}0 & -i \\ i & 0\end{pmatrix},\,\,\tau_3=\begin{pmatrix}1 & 0 \\ 0 & -1\end{pmatrix}$$
