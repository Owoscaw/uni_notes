...
> Fully Non-Linear: Does not fit above
...
> We define characteristics as paths in "phase space" along which a PDE reduces into a system of ODEs.
...
> Using this method, we study [[year 3/partial differential equations 3/term 1/Conservation laws#Breakdown of classical solutions|conservation laws]] that often describe physical quantities. 
> By formulating conservation laws as [[Weak formulation#Existence of weak solutions|weak solutions]], we explore the breakdown of solutions where characteristics cross and how we can classify the curves along which this happens, called [[Weak formulation#Rankine-Hugoniot condition and shocks|shocks]]. 
...
> The Heat equation is the prototypical parabolic PDE, which we solve using [[The Heat equation#Fourier Series and the Heat Equation in $ Re setminus2 pi mathbb{Z}$|Fourier series]]. We further analyse these solutions using the [[The Heat equation#Energy method|energy method]] and [[The Heat equation#Gronwall and Sobolev inequalities|boundedness]] results.
> The Wave equation is not examinable :p