...
\end{align*}$$Now we look for where $u_r=u_\theta=0$. Clearly $u_r=0$ at $r=a$, then $u_\theta=0$ if:$$\Huge\Gamma=4\pi Ua\sin\theta$$So our stagnation points are at:$$\Huge r=a,\,\,\sin\theta=\frac{\Gamma}{4\pi Ua}$$Choosing $\Gamma<0$ forces the stagnation points to be at $\theta<0$:![[Kinematics of Fluids 2025-10-29 15.17.06.excalidraw]]