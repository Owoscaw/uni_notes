...
If $B=[a,b]\times[c,d]$ is a nice [[year 1/calculus 1/term 1/Integration#Double integrals|region]], then the integral can be written as:$$\Huge f_{X,Y}(x,y)=\mathbb{P}((X,Y)\in B)=\iint_Bf(x,y)dxdy$$
