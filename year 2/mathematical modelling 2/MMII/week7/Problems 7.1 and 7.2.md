...
\frac{mv^2}{2}&=q\times10^5\text{eV}\\
v^2&=\frac{2q\times10^5\text{eV}}{m}\\
v&=\sqrt{\frac{2q\times10^5\text{eV}}{m}}=\sqrt{\frac{2\times1.602\times10^{-19}C\times10^5\text{eV}}{1.672\times10^{-27}kg}}\\
&\approx4.377519\times10^6ms^{-1}
...
V&=2\pi R\nu\\
R&=\frac{V}{2\pi\nu}=\frac{4.378\times10^6ms^{-1}}{2\pi\times1.525\times10^7hz}\\
&\approx4.569051\times10^{-2}m=4.569051\,cm
\end{align}$$
