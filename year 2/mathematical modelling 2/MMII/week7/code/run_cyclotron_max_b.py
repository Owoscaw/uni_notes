...
tmax = 5e-7
B = 1
dV = 2.1168e6 # Potential from target
...
v0 = np.sqrt(vx0**2 + vy0**2) # Initial speed
vF = np.sqrt(ode.V[2]**2 + ode.V[3]**2) # Final speed
KeF = 0.5*ode.m*vF**2 # Final kinetic energy
KeFMevs = KeF/(ode.q*1e6)

print("Initial speed: {}\nFinal speed: {}\nFinal kinetic energy (J): {}\nFinal kinetic energy (MeV): {}".format(v0, vF, KeF, KeFMevs))
